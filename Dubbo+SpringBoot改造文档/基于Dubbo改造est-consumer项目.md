# 基于Dubbo改造est-consumer项目

## 1.项目目录结构

![二手兔项目改造后结构图](image\consumer.jpg)

<center>图 est-consumer项目目录结构图</center>

## 2.基于Dubbo改造est-consumer项目

1、est-consumer项目的pom.xml文件中添加依赖，如下所示：
...
oss:
  ...
  #连接Key
  accessKeyId: LTAI4FjxqvfasC5wkZsUY5336DW
  #连接Secret
  accessKeySecret: N4BZB7zBfaZLuSURpnfBuGqTm5VbS2Vp
  #存储空间名称
  bucketName: ljx-est
  #OSS文件访问域名
...
ali:
  sms:
    #连接Key
    accessKeyId: LTAI4FjxqvC5wkZsUY5weq336DW
    #连接Secret
    accessKeySecret: N4BZB7zBZLuSURasdpnfBuGqTm5VbS2Vp
    #模板
...
3、将est-web项目的代码拷贝到est-consumer项目中，如下所示：

![1](image\5-1.jpg)

4、在est-consumer项目新建一层service业务层，该service业务层的实现类中，通过使用@Reference注解调用est-provider中的服务，如下所示：

![2](image\5-2.jpg)

5、在est-consumer启动类添加注解，如下所示：
